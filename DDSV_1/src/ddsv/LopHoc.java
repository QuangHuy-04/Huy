...
import Controller.LopHoc_Controller;
import java.sql.*;
...
public class LopHoc extends javax.swing.JFrame {
    ...
    private LopHoc_Controller lop1;

    /**
     * Creates new form D17CNPM1_CTDLGT
     */

    public LopHoc(ddsv.LichHoc lichHocFrame) {
    ...
    public void updateDataToAllRows(String ngayHoc, int soTiet, String tenLop, String tenMon) {
        ...
        try {
            ...
            Logger.getLogger(LopHoc.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
